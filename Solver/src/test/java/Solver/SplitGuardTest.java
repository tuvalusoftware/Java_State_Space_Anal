...
public class SplitGuardTest {
    ...
    public void threeAND() {
        ...
        String result = "[[a 535353 + 4 ==, c 10 >=, b 2 a * - 0 ==]]";
        assertEquals(infix, Converter.toInfix(guard));
        assertEquals(result,Converter.splitGuard(guard).toString());
    }
    ...
    public void compound211() {
        ...
        String result = "[[a 5 >, b 432 <=], [var0 99 ==], [a b + var0 >=]]";
        assertEquals(infix, Converter.toInfix(guard));
        assertEquals(result,Converter.splitGuard(guard).toString());
    }
    ...
    public void compound131() {
        ...
        String result = "[[x 1 >], [x 2 <, x 3 >, x 4 ==], [huhu 999 ==]]";
        assertEquals(infix, Converter.toInfix(guard));
        assertEquals(result,Converter.splitGuard(guard).toString());
    }
    ...
    public void compound221() {
        ...
        String result = "[[x 5 + 3 y * - 0 <=, 3 y + x + -5 >=], [x y + 0 ==, x 2 y * - 0 <=], [3 y - 27 ==]]";
        assertEquals(infix, Converter.toInfix(guard));
        assertEquals(result,Converter.splitGuard(guard).toString());
    }
    ...
    public void compound213() {
        ...
        String result = "[[x y + 0 ==, x 2 y * - 0 <=], [3-y==27], [x 2 >, x 3 <, y 0 ==]]";
        assertEquals(infix, Converter.toInfix(guard));
        assertEquals(result,Converter.splitGuard(guard).toString());
    }
    ...
    public void compound123() {
        ...
        String result = "[[aaa 5324 + b - 27 >=], [huhuhu 1 + hahaha ==, ok true ==], [x y + z + 0 >, x y + z - 4 <=, zzzz 0 ==]]";
        assertEquals(infix, Converter.toInfix(guard));
        assertEquals(result,Converter.splitGuard(guard).toString());
    }
    ...
    public void compound333() {
        ...
        String result = "[[3 5 2 + - 14 3 x - - ==, a 5 + 4 ==, why true ==], [7 1 2 - 3 + 4 5 - 6 + - - 15 - 3 x - 2 * >=, y 9 ==, z y - 0 >=], [x y + 0 >, y z + 1 <, x y + z - 5335 ==]]";
        assertEquals(infix, Converter.toInfix(guard));
        assertEquals(result,Converter.splitGuard(guard).toString());
    }
